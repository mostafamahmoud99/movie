...
export default function SeriesDetails() {
    ...
    async function getDetails() {
        let { data } = await axios.get(`https://api.themoviedb.org/3/tv/${params.id}?api_key=74052a12ed43d666ebfc2e802b1f07e2&language=en-US`)
        setDetails(data)
    }
